...
'DM BevelEx
'This activeX took about an hour to make. this was ment to be a clone of the BevelEx
' used in Borland Delphi. anyway it has all the features of the normal one and even more

'The features
' Over 11 shapes that include:
' Button raised and lowered style bevels
' 3D Lines that can be aligned to Top,Left,Right and Bottom
' Frame Control bevel like the one in VB without a caption
' Round Frame Control like above
' Outline Rectangle
' Round Rectangle
' Spacer
' and more

' Styles include Raised and Lowered and shape above
' The control and be transparent or Or Opaque
' Supports backcolor, and many more


' If you like this contro please vote.
' if you want to use this in your own projects. then please do , but please do remmber were it came from by adding my name or a link to the code on pscode
' features updates,questions and answers to this and other projects maybe found at
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("LineWidth", m_linewidth, 1)
